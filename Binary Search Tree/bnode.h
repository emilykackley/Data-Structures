/* File: bnode.h
*  Purpose: A node class for a binary tree
*/
...
class BNode {
	...
	public:
		...
		//Purpose: construct a string containing this node's data value and count
		//Returns: a string consisting of this node's data vlue and its count; e.g., if
		//  this node's value is 42 and its count is 3, this returned string will be "42 (3)"
