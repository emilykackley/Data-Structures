/* LinkedList.h
   Purpose: Definition of a class for a doubly linked list
*/
...
class LinkedList
{
	private:
		...
		Node<T> *m_head, *m_tail; //pointers to first and last nodes in list
	public:
		...
		//Returns: true if an occurrence of x successfully removed; otherwise, false
		...
		//Postconditions: all occurrence of x have been removed and currentsize
